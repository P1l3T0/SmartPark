...
const VehicleForm = () => {
  const { handleInputChange, handleDropDownChange, handleSubmit, visible, error, toggleDialog } = useCreateVehicle();
  const {
    VehicleModelInput,
    VehicleBrandInput,
  ...
  return (
    <>
      ...
      />
      <ErrorDialog visible={visible} toggleDialog={toggleDialog} error={error} />
    </>
  );
};
