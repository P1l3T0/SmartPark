          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Parking Spot <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {bookingList.map(booking => (
                <tr key={`entity-${booking.id}`} data-cy="entityTable">
                  ...
                  <td>{booking.startDate ? <TextFormat type="date" value={booking.startDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{booking.endDate ? <TextFormat type="date" value={booking.endDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{booking.dateCreated ? <TextFormat type="date" value={booking.dateCreated} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{booking.status}</td>
                  <td>{booking.userProfile ? <Link to={`/user-profile/${booking.userProfile.id}`}>{booking.userProfile.id}</Link> : ''}</td>
                  <td>{booking.vehicle ? <Link to={`/vehicle/${booking.vehicle.id}`}>{booking.vehicle.id}</Link> : ''}</td>
                  <td>{booking.parkingSpot ? <Link to={`/parking-spot/${booking.parkingSpot.id}`}>{booking.parkingSpot.id}</Link> : ''}</td>
