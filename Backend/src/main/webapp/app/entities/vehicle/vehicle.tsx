            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('registrationNumber')}>
                  Registration Number <FontAwesomeIcon icon={getSortIconByFieldName('registrationNumber')} />
                </th>
            ...
            <tbody>
              {vehicleList.map(vehicle => (
                <tr key={`entity-${vehicle.id}`} data-cy="entityTable">
                  ...
                  <td>{vehicle.dateCreated ? <TextFormat type="date" value={vehicle.dateCreated} format={APP_DATE_FORMAT} /> : null}</td>
