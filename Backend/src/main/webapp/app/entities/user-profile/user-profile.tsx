            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('photoUrl')}>
                  Photo Url <FontAwesomeIcon icon={getSortIconByFieldName('photoUrl')} />
                </th>
                ...
                <th className="hand" onClick={sort('dateUpdated')}>
                  Date Updated <FontAwesomeIcon icon={getSortIconByFieldName('dateUpdated')} />
                </th>
                <th>
            ...
            <tbody>
              {userProfileList.map(userProfile => (
                <tr key={`entity-${userProfile.id}`} data-cy="entityTable">
                  ...
                  <td>{userProfile.photoUrl}</td>
                  <td>
                    {userProfile.dateCreated ? <TextFormat type="date" value={userProfile.dateCreated} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {userProfile.dateUpdated ? <TextFormat type="date" value={userProfile.dateUpdated} format={APP_DATE_FORMAT} /> : null}
                  </td>
