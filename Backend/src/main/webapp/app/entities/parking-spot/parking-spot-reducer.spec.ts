...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARKINGSPOT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARKINGSPOT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARKINGSPOT actions', async () => {
      const arg = { id: 24525 };
    ...
    it('dispatches UPDATE_PARKINGSPOT actions', async () => {
      const arg = { id: 24525 };
    ...
    it('dispatches PARTIAL_UPDATE_PARKINGSPOT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARKINGSPOT actions', async () => {
      const arg = 42666;
