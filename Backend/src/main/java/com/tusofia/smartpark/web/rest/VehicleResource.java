...
import com.tusofia.smartpark.service.VehicleService;
...
/**
 * REST controller for managing {@link com.tusofia.smartpark.domain.Vehicle}.
 */
@RestController
...
public class VehicleResource {
    ...
    public ResponseEntity<VehicleDTO> createVehicle(@Valid @RequestBody VehicleDTO vehicleDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/vehicles/" + vehicleDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, vehicleDTO.getId().toString()))
            .body(vehicleDTO);
    }
