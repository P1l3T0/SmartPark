package com.tusofia.smartpark.security.jwt;

import static com.tusofia.smartpark.security.AuthoritiesConstants.ADMIN;
...
public class JwtAuthenticationTestUtils {
    ...
    public static String createValidTokenForUser(String jwtKey, String user) {
        return createToken(jwtKey, user, ACCESS_TOKEN_TYPE, 60);
    }

    public static String createRefreshTokenForUser(String jwtKey, String user) {
        return createToken(jwtKey, user, REFRESH_TOKEN_TYPE, 60);
    }

    private static String createToken(String jwtKey, String user, String tokenType, long expiresInSeconds) {
