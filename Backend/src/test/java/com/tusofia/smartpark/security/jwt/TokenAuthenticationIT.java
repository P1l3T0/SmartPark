...
import static com.tusofia.smartpark.security.jwt.JwtAuthenticationTestUtils.*;
...
class TokenAuthenticationIT {
    ...
    @Test
    void testReturnFalseWhenRefreshTokenIsUsedAsAccessToken() throws Exception {
        expectUnauthorized(createRefreshTokenForUser(jwtKey, "anonymous"));
    }
