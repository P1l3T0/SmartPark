...
import com.tusofia.smartpark.service.UserProfileService;
import com.tusofia.smartpark.service.dto.UserProfileDTO;
import com.tusofia.smartpark.service.mapper.UserProfileMapper;
...
class UserProfileResourceIT {
    ...
    void checkDateCreatedIsRequired() throws Exception {
        ...
        // set the field null
        userProfile.setDateCreated(null);
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.phoneNumber(UPDATED_PHONE_NUMBER).photoUrl(UPDATED_PHOTO_URL).dateUpdated(UPDATED_DATE_UPDATED);
